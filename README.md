...
雨课堂刷课脚本 fork from [Cat1007/yuketangHelperSCUTLite](https://github.com/Cat1007/yuketangHelperSCUTLite)
             ...
             fork again from [MuWinds/yuketangHelperBUU](https://github.com/MuWinds/yuketangHelperBUU)
             
20250320更新：优化了一下交互界面，在cmd命令行中添加了类似窗口的界面，现启动时BUU用户可省去输入域名步骤
...
5. 安装依赖：pip install -r requirements.txt (若pip后仍出现缺少依赖的情况，请报告）
