...
def getUniversityId(domain):
    ...
    data = response['data']
    cmdline_menu.echo_info("DEBUG",data['university_id'])
...
def extract_specific_cookies(cookie_string):
    ...
    for cookie in cookie_string.split(','):
        ...
        if '=' in key_value:
            ...
            cookies[key] = value
    cmdline_menu.echo_info("DEBUG","csrftoken: " + cookies.get('csrftoken'))
    cmdline_menu.echo_info("DEBUG","sessionid: " + cookies.get('sessionid'))
    # 返回特定的cookie
